    ...
    if($resultado = $mysql->query($sql))
    {
        ...
        else
        {
            ...
            while($fila = $resultado->fetch_row())
            {
                ...
                $tabla .="<td class='anchoC'><a class='waves-effect waves-light btn red lighten-1 modal-trigger botonesm modaleliminar' onclick=\"EliminarGasto('".$fila["3"]."')\"><i class='material-icons left'><img class='iconoaddcrud' src='../app/img/boton-borrar.png' /></i></a></td>";
                $tabla .= "</tr>";
...
function mostrarGastoFlujo($datos)
{
