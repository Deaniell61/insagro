  ...
  function mostrarVentasSinC($datos)
  {
session_start();
...
$busca="";
  ...
  function cargarDetalleVentasSinC($id)
  {
...
$total=0;
  ...
  function mostrarVentasSinCPorFecha($datos)
  {
session_start();
