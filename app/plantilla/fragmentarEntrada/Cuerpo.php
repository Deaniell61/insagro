        ...
        <div class="input-field col s8 " style="display:none">
         ...
         <div class="input-field col s10" style="display:none">
            ...
            <div class="input-field col s6 ">
                ...
                <label for="icon_telephone" ><span class="etiquelogin">Cantidad De Entrada</span></label>
            </div>
            ...
            <div class="input-field col s6 ">
                ...
                <label for="icon_telephone" ><span class="etiquelogin">Descripcion de Entrada</span></label>
            </div>
