                    ...
                    <div class="col s12">
                        <ul id="tabsn" class="tabsUsuarios centrartab blue darken-1 ">
                            <div class="lipUsuario">
                                ...
                                <li class="centrarli"><a id="consignacionxCobrar" href="#" class="yellow darken-4 btn white-text tamatabsa  "><i class="material-icons left"><img class="iconotab" src="../app/img/avatar.png" /></i>Consignacion Por Cobrar</a></li>
