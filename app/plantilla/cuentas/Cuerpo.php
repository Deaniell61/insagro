<div id="contenidoCrud">
    ...
    <ul class="collapsible popout" data-collapsible="accordion">
        <li>
            <div class="collapsible-header"><i class="material-icons"><img class="imgSub" src="../app/img/flecha-hacia-abajo-signo-para-navegar.png" /></i>Cuentas</div>
...
<div>
   <img id="iniciologo" src="../app/img/insagro2.png" class="marcaagua">
   </div>
