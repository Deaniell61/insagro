...
<center>
                ...
                <center style="">
                <li class="centrarli">
                    <a id="inventarioCoSal"  class="red accent-2 btn white-text  " ><i class="material-icons left"><img class="iconotab" src="../app/img/salida.png" /></i>Compras</a>
                <a id="inventarioCoEntrada"  class="green accent-5 btn white-text  " ><i class="material-icons left"><img class="iconotab" src="../app/img/entrada.png" /></i>Ventas</a></li>
                </center>
