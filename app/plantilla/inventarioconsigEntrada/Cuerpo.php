...
<center>
                ...
                <center style="">
                <li class="centrarli">
                    <a id="inventarioCoSal"  class="red accent-2 btn white-text  " ><i class="material-icons left"><img class="iconotab" src="../app/img/salida.png" /></i>Por Pagar</a>
                <a id="inventarioCoEntrada"  class="green accent-5 btn white-text  " ><i class="material-icons left"><img class="iconotab" src="../app/img/entrada.png" /></i>Por Cobrar</a></li>
                </center>
