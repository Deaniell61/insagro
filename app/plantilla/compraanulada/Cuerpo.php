...
<div style="display:none;">
        <center>
            <div class="radioFiltro">
                ...
                <input class="radioColor" name="filtro" value="1" checked type="radio" id="motos" onChange=" mostrarComprasAnul();" />
            ...
            <div class="radioFiltro carroEspacio">
                ...
                <input class="radioColor" name="filtro" value="2" type="radio" id="carros" onChange=" mostrarComprasAnul();" />
