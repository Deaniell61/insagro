...
<ul id="tabsn" class="tabsUsuarios centrartab blue darken-1 ">
    <div class="lipUsuario">
           ...
           <li class="centrarli"><a id="estadisticaVentas" href="#" class=" btn white-text amber accent-4  tamatabsa  ">Ventas</a></li>
            <li class="centrarli"><a id="estadisticaClientes" href="#" class=" btn white-text  yellow darken-4 tamatabsa  ">Clientes</a></li>
...
<center>
    	...
    	<div class="col s12">
    			                 ...
    			                 <div class="input-field col s6">
								  ...
								  <input  id="fechaI" class="fechas" type="date" class="validate" onChange="cargarGrafico('10','');cargarGrafico('11','');" value="<?php echo date('Y-m-d')?>" >
                                  ...
                                  <i  class="material-icons prefix"><img class="iconologin" src="../app/img/fecha.png"/></i>
								  <input  id="fechaF" class="fechas" type="date" class="validate" onChange="cargarGrafico('10','');cargarGrafico('11','');" value="<?php echo date('Y-m-d')?>" >
