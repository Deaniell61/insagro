	  ...
	  ?>
           <div>
         	<ul>
                 ...
                 <li class="centrarli"><a id="ventasSinC" href="#!" class="red accent-3 btn white-text  " ><i class="material-icons left"><img class="iconotab" src="../app/img/generarv.png" /></i>Sin Comprobante</a></li>
...
<center>
                  <li class="centrarli"><a id="imprimirT" onClick="printReporteVenta(1);" class="amber accent-3 btn white-text tamaniobot " ><i class="material-icons left"><img class="iconotab" src="../app/img/imprimir.png" /></i>Reporte de Ventas</a></li>
                  </center>
                <div class="col s12 ">
                    <div id="mensaje3"></div>
                    <!-- reumen -->
