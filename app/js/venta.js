...
function verificaProductoVenta()
{
	...
	{
		ingresoVenta(document.getElementById('codigoProd').value);
	}
	else
	{
...
function printReporteVenta(tipo)
{
			...
			setTimeout("location.href='../core/modelo/reportes/ventasReportes.php?tipo="+tipo+"&filtro="+filto+"'", 100);
